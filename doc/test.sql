...
alter table merchant_brand add constraint FKmc35vasrbk8mxo2c0bwa14iyy foreign key (uuid) references rate_check_in;

alter table rate_check_in_log add constraint FKpeurc8bxgixbnrn8saa9scv9r foreign key (merchant_brand_id) references merchant_brand;
